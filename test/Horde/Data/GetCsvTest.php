...
{
    protected function readCsv($file, $conf = [])
    {
...
Come check out the new resource!',
            ...
            $this->readCsv('bug_3839.csv', ['length' => 12, 'separator' => '~'])
        );
    }
...
',
            ...
            $this->readCsv('bug_4025.csv', ['length' => 22])
        );
    }
...
',
            ...
            $this->readCsv('bug_6311.csv', ['length' => 92])
        );
    }
...
123 Main Street',
            ...
            $this->readCsv('bug_6370.csv', ['length' => 92])
        );
    }
...
',
            ...
            $this->readCsv('bug_6372.csv', ['length' => 92])
        );
    }

    public function testLineEndings()
    {
        foreach (['simple_lf', 'simple_crlf', 'notrailing_lf', 'notrailing_crlf'] as $test) {
            $this->assertEquals(
                [
                    0
                     => [
